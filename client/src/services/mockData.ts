import type { ApiEndpoint, HealthCheck, DashboardStats } from '../types';
...
export function computeDashboardStats(endpoints: ApiEndpoint[], checksHistory: Record<string, HealthCheck[]>): DashboardStats {
